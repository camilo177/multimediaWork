...
export default function ModeloInicio() {
  ...
  // Note: Make sure the file path for the penguin is correct (case sensitive)
  const audioPinguino = useRef(new Audio("/assets/pinguin.mp3"));
  const noteTextures = [
  ...
  // 📌 Función para reproducir sonido del pingüino
